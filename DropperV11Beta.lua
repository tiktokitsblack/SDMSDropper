...
local function showBootPanel(titleText: string, bodyText: string)
	...
	frame.BackgroundColor3 = Color3.fromRGB(2, 6, 4)
	...
	frameStroke.Color = Color3.fromRGB(57, 255, 140)
	frameStroke.Thickness = 1
	frameStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	frameStroke.Parent = frame
	local title = Instance.new("Frame")
	title.Size = UDim2.new(1, 0, 0, 36)
	title.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
	title.BorderSizePixel = 0
	title.Parent = frame
	local titleFace = applyBevel(title, Color3.fromRGB(57, 255, 140), 0.88, true)
	...
	titleLabel.TextColor3 = Color3.fromRGB(57, 255, 140)
	...
	body.Text = "> " .. bodyText
	body.TextColor3 = Color3.fromRGB(170, 255, 195)
...
local function createLocalUI()
	...
	-- Hacker terminal card: near-black green-tinted shell, phosphor accents.
	local frame = Instance.new("Frame")
	frame.Name = "Panel"
	...
	local stroke = Instance.new("UIStroke")
	stroke.Color = Color3.fromRGB(57, 255, 140)
	stroke.Thickness = 1
	...
	header.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
	header.BorderSizePixel = 0
	header.Parent = frame
	local headerLine = Instance.new("Frame")
	headerLine.Size = UDim2.new(1, 0, 0, 1)
	headerLine.Position = UDim2.new(0, 0, 1, -1)
	headerLine.BackgroundColor3 = Color3.fromRGB(57, 255, 140)
	...
	avatar.BackgroundColor3 = Color3.fromRGB(6, 16, 10)
	...
	avatarRing.Color = Color3.fromRGB(57, 255, 140)
	avatarRing.Thickness = 2
	avatarRing.Transparency = 0.15
	...
	nameLabel.TextColor3 = Color3.fromRGB(180, 255, 200)
	...
	subLabel.TextColor3 = Color3.fromRGB(90, 180, 120)
	...
	pill.BackgroundColor3 = Color3.fromRGB(90, 140, 110)
	...
	phaseDotLabel.TextColor3 = Color3.fromRGB(90, 180, 120)
	...
	progressTitle.TextColor3 = Color3.fromRGB(90, 180, 120)
	...
	track.BackgroundColor3 = Color3.fromRGB(6, 14, 9)
	track.BorderSizePixel = 0
	track.Parent = frame
	local trackStroke = Instance.new("UIStroke")
	trackStroke.Color = Color3.fromRGB(57, 255, 140)
	trackStroke.Thickness = 1
	trackStroke.Transparency = 0.7
	trackStroke.Parent = track
	local fill = Instance.new("Frame")
	fill.Size = UDim2.new(0, 0, 1, 0)
	fill.BackgroundColor3 = Color3.fromRGB(57, 255, 140)
	...
	local function addRow(key: string, prefix: string, order: number)
		...
		row.BackgroundColor3 = Color3.fromRGB(5, 11, 7)
		...
		rowStroke.Color = Color3.fromRGB(57, 255, 140)
		...
		keyLabel.TextColor3 = Color3.fromRGB(100, 200, 140)
		...
		valueLabel.Text = "--"
		valueLabel.TextColor3 = Color3.fromRGB(170, 255, 195)
	...
	footer.TextColor3 = Color3.fromRGB(70, 150, 100)
...
local function createHostUI()
	...
	titleText.Text = "[ DROPPER // HOST_CONSOLE ]"
	titleText.TextXAlignment = Enum.TextXAlignment.Left
	titleText.TextColor3 = Color3.fromRGB(57, 255, 140)
	...
	titleLine.BackgroundColor3 = Color3.fromRGB(57, 255, 140)
	...
	liveDot.BackgroundColor3 = Color3.fromRGB(57, 255, 140)
	...
	minimizeBtn.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
	minimizeBtn.BackgroundTransparency = 0
	minimizeBtn.Text = "-"
	minimizeBtn.TextColor3 = Color3.fromRGB(57, 255, 140)
	...
	minimizeBtnCorner.CornerRadius = UDim.new(0, 2)
	minimizeBtnCorner.Parent = minimizeBtn
	local minimizeBtnStroke = Instance.new("UIStroke")
	minimizeBtnStroke.Color = Color3.fromRGB(57, 255, 140)
	minimizeBtnStroke.Thickness = 1
	minimizeBtnStroke.Transparency = 0.4
	...
	hideBtn.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
	hideBtn.BackgroundTransparency = 0
	hideBtn.Text = "x"
	hideBtn.TextColor3 = Color3.fromRGB(57, 255, 140)
	...
	hideBtnStroke.Color = Color3.fromRGB(57, 255, 140)
	hideBtnStroke.Thickness = 1
	hideBtnStroke.Transparency = 0.4
	...
	showPill.BackgroundColor3 = Color3.fromRGB(2, 6, 4)
	showPill.Text = "[ DROPPER :: SHOW ]"
	showPill.TextColor3 = Color3.fromRGB(57, 255, 140)
	...
	showPillCorner.CornerRadius = UDim.new(0, 2)
	showPillCorner.Parent = showPill
	local showPillStroke = Instance.new("UIStroke")
	showPillStroke.Color = Color3.fromRGB(57, 255, 140)
	showPillStroke.Thickness = 1
	showPillStroke.Transparency = 0.45
	...
	subtitle.TextColor3 = Color3.fromRGB(90, 180, 120)
	...
	local function makeStatCard(xPos: number, width: number): (Frame, TextLabel, TextLabel)
		...
		card.BackgroundColor3 = Color3.fromRGB(5, 11, 7)
		...
		cardStroke.Color = Color3.fromRGB(57, 255, 140)
		...
		micro.TextColor3 = Color3.fromRGB(90, 180, 120)
		...
		main.TextColor3 = Color3.fromRGB(170, 255, 195)
	...
	overallTrack.BackgroundColor3 = Color3.fromRGB(6, 14, 9)
	...
	overallFill.BackgroundColor3 = Color3.fromRGB(57, 255, 140)
	...
	overallFillGrad.Color = ColorSequence.new({
		...
		ColorSequenceKeypoint.new(1, Color3.fromRGB(57, 255, 140)),
	})
	...
	local function makeTab(text: string, xPos: number): TextButton
		...
		b.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
		b.Text = text
		b.TextColor3 = Color3.fromRGB(90, 180, 120)
		...
		c.Parent = b
		local s = Instance.new("UIStroke")
		s.Color = Color3.fromRGB(57, 255, 140)
		s.Thickness = 1
		s.Transparency = 0.55
		s.Parent = b
		...
		bar.BackgroundColor3 = Color3.fromRGB(57, 255, 140)
	...
	local function selectTab(which: string)
		...
		altsTab.BackgroundColor3 = (which == "Alts") and Color3.fromRGB(57, 255, 140) or Color3.fromRGB(4, 12, 8)
		timeTab.BackgroundColor3 = (which == "Time") and Color3.fromRGB(57, 255, 140) or Color3.fromRGB(4, 12, 8)
		clientTab.BackgroundColor3 = (which == "Client") and Color3.fromRGB(57, 255, 140) or Color3.fromRGB(4, 12, 8)
		altsTab.TextColor3 = (which == "Alts") and Color3.fromRGB(2, 6, 4) or Color3.fromRGB(90, 180, 120)
		timeTab.TextColor3 = (which == "Time") and Color3.fromRGB(2, 6, 4) or Color3.fromRGB(90, 180, 120)
		clientTab.TextColor3 = (which == "Client") and Color3.fromRGB(2, 6, 4) or Color3.fromRGB(90, 180, 120)
	...
	searchBox.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
	searchBox.Text = ""
	searchBox.PlaceholderText = "> filter alts_"
	searchBox.PlaceholderColor3 = Color3.fromRGB(70, 150, 100)
	searchBox.TextColor3 = Color3.fromRGB(170, 255, 195)
	...
	searchStroke.Color = Color3.fromRGB(57, 255, 140)
	...
	header.BackgroundColor3 = Color3.fromRGB(8, 18, 12)
	header.BorderSizePixel = 0
	...
	hStroke.Color = Color3.fromRGB(57, 255, 140)
	hStroke.Thickness = 1
	...
	for _, col in ipairs(COLS) do
		...
		lbl.TextColor3 = Color3.fromRGB(90, 180, 120)
	...
	rowsFrame.ScrollBarImageColor3 = Color3.fromRGB(57, 255, 140)
	...
	for i, uid in ipairs(Settings.AccountUserIds) do
		...
		rowFrame.BackgroundColor3 = (i % 2 == 0) and Color3.fromRGB(6, 14, 9) or Color3.fromRGB(4, 11, 7)
		...
		rowFrame.MouseEnter:Connect(function()
			rowFrame.BackgroundColor3 = Color3.fromRGB(10, 26, 16)
		end)
		...
		altAvatar.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
		...
		altRing.Color = Color3.fromRGB(57, 255, 140)
		altRing.Thickness = 1.5
		altRing.Transparency = 0.3
		...
		for _, col in ipairs(COLS) do
			...
			lbl.Text = "—"
			lbl.TextXAlignment = Enum.TextXAlignment.Left
			lbl.TextColor3 = Color3.fromRGB(170, 255, 195)
			lbl.Font = Enum.Font.Code
			lbl.TextSize = 12
			lbl.TextTruncate = Enum.TextTruncate.AtEnd
			lbl.Parent = rowFrame
			if col.key == "status" then
				lbl.BackgroundColor3 = Color3.fromRGB(6, 20, 12)
				lbl.BorderSizePixel = 0
				lbl.Font = Enum.Font.Code
				lbl.TextSize = 11
				lbl.TextXAlignment = Enum.TextXAlignment.Center
				local pillStroke = Instance.new("UIStroke")
				pillStroke.Color = Color3.fromRGB(57, 255, 140)
	...
	local function addTimeRow(key: string, prefix: string, order: number)
		...
		row.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
		row.BorderSizePixel = 0
		row.Text = "> " .. prefix .. ": —"
		row.TextColor3 = Color3.fromRGB(170, 255, 195)
		...
		accent.BackgroundColor3 = Color3.fromRGB(57, 255, 140)
	...
	headerRow.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
	...
	headerStroke.Color = Color3.fromRGB(57, 255, 140)
	...
	avatar.BackgroundColor3 = Color3.fromRGB(4, 12, 8)
	avatar.BorderSizePixel = 0
	avatar.Image = ""
	...
	addClientHeaderLabel("username", 8, true, 15, Color3.fromRGB(170, 255, 195))
	addClientHeaderLabel("display", 29, false, 13, Color3.fromRGB(120, 210, 150))
	addClientHeaderLabel("userid", 49, false, 12, Color3.fromRGB(90, 180, 120))
