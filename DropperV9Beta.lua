...
local function showBootPanel(titleText: string, bodyText: string)
	...
	frameStroke.Color = Color3.fromRGB(52, 64, 90)
	...
	body.Text = bodyText
	body.TextColor3 = Color3.fromRGB(203, 213, 228)
...
local function updateLocalUI()
	...
	if localAltDot then
		if s.phase == "Done" then
			localAltDot.BackgroundColor3 = Color3.fromRGB(86, 224, 135)
		elseif s.phase == "Killing" or s.phase == "Dropping" or s.phase == "Teleporting" or s.phase == "Syncing" or s.phase == "Respawning" then
			localAltDot.BackgroundColor3 = Color3.fromRGB(53, 186, 243)
		else
			localAltDot.BackgroundColor3 = Color3.fromRGB(120, 130, 150)
		end
	end
