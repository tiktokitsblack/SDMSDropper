...
local function createLocalUI()
	...
	minimize.BackgroundColor3 = Color3.fromRGB(30, 37, 56)
	minimize.Text = "–"
	minimize.TextColor3 = Color3.fromRGB(203, 213, 228)
	...
	minimizeStroke.Color = Color3.fromRGB(52, 64, 90)
...
local function createHostUI()
	...
	local titlePad = Instance.new("UIPadding")
	titlePad.PaddingLeft = UDim.new(0, 14)
	titlePad.PaddingRight = UDim.new(0, 150)
	titlePad.Parent = title
